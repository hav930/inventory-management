...
# Restocking orders submitted via the Restocking tab live here in-memory only.
# Intentionally not file-backed: cleared on server restart per product decision.
